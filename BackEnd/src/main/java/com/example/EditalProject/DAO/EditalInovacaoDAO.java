...
public class EditalInovacaoDAO {
    public void insere(EditalInovacao edital) {
        try (Connection conexao = ConnectionFactory.getConnection()) {
            // Inserir os dados em uma tabela
            PreparedStatement stmt = conexao.prepareStatement("INSERT INTO tabela_edital_inovacao (titulo, descricao, prazo, criterios_selecao, requisitos) VALUES (?, ?, ?, ?, ?)");
