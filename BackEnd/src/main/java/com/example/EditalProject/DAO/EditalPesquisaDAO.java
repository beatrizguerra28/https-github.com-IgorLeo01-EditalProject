...
public class EditalPesquisaDAO {
    public void insere(EditalPesquisa edital) {
        try (Connection conexao = ConnectionFactory.getConnection()) {
            // Inserir os dados em uma tabela
            PreparedStatement stmt = conexao.prepareStatement("INSERT INTO tabela_edital_pesquisa (titulo, descricao, prazo, criterios_selecao, requisitos) VALUES (?, ?, ?, ?, ?)");
